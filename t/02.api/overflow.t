...
my $new_rc = ($rcl_a->create_new(
    '-name' => 'testresourceclass',
))[0];

my $long_sca = 'sc' x 129;
my $long_wca = 'wc' x 129;
my $new_rd = $rde_a->create_new(
    '-resource_class_id'   => $new_rc->dbID(),
...
my $new_acr = $acr_a->create_new(
    'condition_analysis_url' => $long_cau,
    'ctrled_analysis_id'        => $ctrled_analysis_id,
);
